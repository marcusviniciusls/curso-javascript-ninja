...
*/
// ?
function calculador(operador, valor1, valor2){
    if (isOperatorValid(operador)){
        return false;
    } else {
        return checarDoisNumeros(operador, valor1, valor2);
    }
}
function checarDoisNumeros(operador, valor1, valor2){
...
*/
// ?
function showOperationMessage(operador, valor1, valor2){
    return 'A operação ' + valor1 + ' ' + operador + ' ' + valor2;
}
...
// ?
operationSignal = '+';
var sum = calculador('+', numero1, numero2);
